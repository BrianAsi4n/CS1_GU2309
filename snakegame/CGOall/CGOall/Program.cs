...
namespace CGOall
{
    internal class Program
    {
        ...
        // chich toc do chay ran theo range diem
        int getDelay()
        {
        ...
        void Render()
        {
            ...
            Console.WriteLine($"Your score:{score} | Diem cao nhat {highScore} ");
        }
        //Xu ly khi THUA
        int highScore = 0; // cAP NHAT DIEm cao nhat
        void Lose()
        {
            if (highScore < score) highScore = score;// cap nhat diem cao nhat sau khi thua
